...
type requestEstimateResp struct {
	Estimate
}
...
type productReq struct {
	surgeMultiplier  float64 `query:"surge_multiplier"`
	driversAvailable bool    `query:"drivers_available"`
}
